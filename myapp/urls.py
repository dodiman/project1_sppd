...
urlpatterns = [
	...
	# ini untuk siapa saja yang daftar dengan menggunakan akun yang dibuat sendiri
	path('siapasaja', views.index_siapasaja, name='myapp_index_siapasaja'),
	path('surat_perintah_siapasaja', views.surat_perintah_siapasaja, name='myapp_surat_perintah_siapasaja'),
	# path('create_surat_perintah_admin', views.createSuratPerintahAdmin, name="myapp_create_surat_perintah_admin"),
	path('show_surat_perintah_siapasaja/<str:pk>/', views.showSuratePerintahsiapasaja, name="myapp_show_surat_perintah_siapasaja"),
	# path('update_surat_perintah_admin/<str:pk>/change', views.upadateSuratePerintahAdmin, name="myapp_update_surat_perintah_admin"),
	# path('delete_surat_perintah_admin/<str:pk>/', views.deleteSuratePerintah, name="myapp_delete_surat_perintah_admin"),
	# path('delete_surat_perintah_admin_/<str:pk>/', views.deleteSuratePerintah_, name="myapp_delete_surat_perintah_admin_"),


	path('sppd_siapasaja', views.sppdsiapasaja, name='myapp_sppd_siapasaja'),
	# path('create_sppd_admin/<str:pk>/', views.createSppdAdmin, name="myapp_create_sppd_admin"),
	# path('update_sppd_admin/<str:pk>/change', views.upadateSppdAdmin, name="myapp_update_sppd_admin"),
	path('show_sppd_siapasaja/<str:pk>/', views.showSppdsiapasaja, name="myapp_show_sppd_siapasaja"),
	# path('delete_sppd_admin/<str:pk>/', views.deleteSppdAdmin, name="myapp_delete_sppd_admin"),

	path('laporan_siapasaja', views.laporansiapasaja, name='myapp_laporan_siapasaja'),
	# # path('show_laporan_admin/<str:pk>/', views.showLaporanAdmin, name="myapp_show_laporan_admin"),

	path('pengeluaran_siapasaja', views.pengeluaransiapasaja, name='myapp_pengeluaran_siapasaja'),
	# path('create_pengeluaran_admin', views.createPengeluaranAdmin, name="myapp_create_pengeluaran_admin"),
	path('show_pengeluaran_siapasaja/<str:pk>/', views.showPengeluaransiapasaja, name="myapp_show_pengeluaran_siapasaja"),
	# path('update_pengeluaran_admin/<str:pk>/change', views.updatePengeluaranAdmin, name="myapp_update_pengeluaran_admin"),
	path('show_rincian_siapasaja/<str:pk>/', views.showRinciansiapasaja, name="show_rincian_siapasaja"),
	# path('delete_pengeluaran_admin/<str:pk>/', views.deletePengeluaranAdmin, name="myapp_delete_pengeluaran_admin"),
